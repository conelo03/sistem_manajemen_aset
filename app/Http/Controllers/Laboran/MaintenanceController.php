...
class MaintenanceController extends Controller
{
  ...
  public function index()
  {
    ...
    return view('laboran/maintenance', ['maintenance' => $maintenance]);
  }
  ...
  public function create()
  {
    ...
    return view('laboran/tambahMaintenance', [
      'aset'  => $aset,
      'mitra' => $mitra
    ]);
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect('/laboran/maintenance')->with('status', 'Berhasil tambah maintenance.');
  }
  
  public function show($id)
  {
    $maintenance  = $this->maintenance->find($id);
    return view('laboran/editMaintenance', $maintenance);
  }
  ...
  public function update(Request $request, $id)
  {
    ...
    return redirect('/laboran/maintenance')->with('status', 'Berhasil edit data maintenance.');
  }
  ...
  public function history()
  {
    ...
    return view('laboran/historyMaintenance', ['maintenance' => $maintenance]);
  }
