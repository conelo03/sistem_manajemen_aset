...
<div class="container-fluid mt-3">
  <div class="card">
    ...
    <div class="card-body">
      <a href="/staff_keuangan/pengadaan/tambah" class="btn btn-primary mb-3">Tambah</a>
      <a href="/staff_keuangan/pengadaan/print" target="_blank" class="btn btn-primary mb-3">Cetak</a>
      @if (session('status'))
          ...
          <tbody>
            ...
            @foreach ($pengadaan as $pengadaan)
              <tr>
                ...
                <td>
                  <a href="/staff_keuangan/pengadaan/edit/{{ $pengadaan->id }}" class="btn btn-sm btn-success">Edit</a>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="/staff_keuangan/pengadaan/hapus/{{ $pengadaan->id }}" class="btn btn-danger">Hapus</a>
                        </div>
                      </div>
                    </div>
                  </div>
