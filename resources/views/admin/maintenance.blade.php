...
<div class="container-fluid mt-3">
  <div class="card">
    ...
    <div class="card-body">
      <a href="/admin/maintenance/tambah" class="btn btn-primary mb-3">Tambah</a>
      <a href="/admin/maintenance/print" class="btn btn-primary mb-3" target="_blank">Cetak</a>
      @if (session('status'))
          ...
          <tbody>
            @foreach ($maintenance as $maintenance)
              <tr>
                ...
                <td>
                  <a href="/admin/maintenance/edit/{{ $maintenance->id }}" class="btn btn-success">Edit</a>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="/admin/maintenance/hapus/{{ $maintenance->id }}" class="btn btn-danger">Hapus</a>
                        </div>
                      </div>
                    </div>
                  </div>
