...
<div class="container-fluid mt-3">
  <div class="card">
    ...
    <form action="/kaur_laboratorium/maintenance/tambah" method="post">
      @csrf
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group">
              ...
              <input type="text" id="input-username" class="form-control" placeholder="Kode Barang" name="kode_maintenance" required>
            </div>
            <div class="form-group">
