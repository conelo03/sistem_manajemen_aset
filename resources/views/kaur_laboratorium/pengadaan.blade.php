...
<div class="container-fluid mt-3">
  <div class="card">
    ...
    <div class="card-body">
      <a href="/kaur_laboratorium/pengadaan/tambah" class="btn btn-primary mb-3">Tambah</a>
      <a href="/kaur_laboratorium/pengadaan/print" target="_blank" class="btn btn-primary mb-3">Cetak</a>
      @if (session('status'))
