          ...
          <tbody>
            ...
            @foreach ($aset as $aset)
              <tr>
                ...
                <td>{{ $aset->kondisi }}</td>
                <td>
                  <a href="/kaur_laboratorium/data_aset/edit/{{ $aset->id }}" class="btn btn-success">Edit</a>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="/kaur_laboratorium/data_aset/hapus/{{ $aset->id }}" class="btn btn-danger">Hapus</a>
                        </div>
                      </div>
                    </div>
                  </div>
