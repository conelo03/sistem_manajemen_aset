...
<div class="container-fluid mt-3">
  <div class="card">
    ...
    <div class="card-body">
      <a href="/laboran/maintenance/tambah" class="btn btn-primary mb-3">Tambah</a>
      <a href="/laboran/maintenance/print" class="btn btn-primary mb-3" target="_blank">Cetak</a>
      @if (session('status'))
          ...
          <tbody>
            @foreach ($maintenance as $maintenance)
              <tr>
                ...
                <td>
                  <a href="/laboran/maintenance/edit/{{ $maintenance->id }}" class="btn btn-success">Edit</a>
                  <!-- Button trigger modal -->
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapus{{ $maintenance->id }}">
                    Hapus
                  </button>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="/laboran/maintenance/hapus/{{ $maintenance->id }}" class="btn btn-danger">Hapus</a>
                        </div>
                      </div>
                    </div>
                  </div>
